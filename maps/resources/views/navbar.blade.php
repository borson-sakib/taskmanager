            ...
            <div class="max-w-6xl mx-auto px-4">
                <div class="flex justify-between">
                    <div class="flex space-x-7">
                        <div>
                            <!-- Website Logo -->
                            <a href="{{route('landingPage')}}" class="flex items-center py-4 px-2">
                                <img src="{{asset ('img/smec.png')}}" alt="Logo" class="h-12 w-18 mx-4">
                        ...
                        <div class="hidden md:flex items-center space-x-1">
                            ...
                            <a href="{{route('memberRegistration')}}"
                                class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Be a Member</a>
                           <!--  <a href=""
